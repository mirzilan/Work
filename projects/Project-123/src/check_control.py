...
CHECKS = [
    ...
    ("Assumptions_Constant", "Active column resolves (Total Capex > 0)", "B24", "flag"),
    ("Assumptions_Constant", "All scenario cells populated", "B25", "flag"),
    ("Assumptions_Periodic_Capex", "Active phasing sums to 100%", "B34", "flag"),
    ("Assumptions_Periodic_Capex", "All 10 scenario phasings sum to 100%", "B35", "flag"),
    ("Assumptions_Periodic_Ops", "Escalation indices start at 1.00", "B49", "flag"),
    ("Assumptions_Periodic_Ops", "Active volume indices > 0 every quarter", "B50", "flag"),
    ("Calc_Revenue_Opex", "Year 1 Revenue Sum = Annual Revenue Input", "F16", "flag"),
    ("Calc_Revenue_Opex", "Quarters with negative EBITDA", "CD17", "info"),
    ...
    ("Calc_Financing_Ops", "Debt sizing capped by Max Gearing", "CD30", "info"),
